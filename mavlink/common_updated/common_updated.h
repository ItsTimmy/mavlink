/** @file
 *  @brief MAVLink comm protocol generated from common_updated.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_COMMON_UPDATED_H
#define MAVLINK_COMMON_UPDATED_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_COMMON_UPDATED.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#include "./mavlink_msg_mavlink_service_version.h"
...
#endif // __cplusplus
#endif // MAVLINK_COMMON_UPDATED_H
